...
export default async function SignupPage({
  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-amber-50/40 px-4 py-12 dark:bg-zinc-950">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          Your progress will be saved and you&apos;ll appear on the leaderboards.
        </p>
